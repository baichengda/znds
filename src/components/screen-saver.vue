<template>
    <div ref="carouselModel" class="carouselModel">
        ...
        <div class="carousel-single">
            <ul>
                <li @click="goQuery('floorOverview')">
                    <p>
                ...
                <li @click="goQuery('personnelQuery')">
                    <p>
                ...
                <li @click="goQuery('instrumentQuery')">
                    <p>
                ...
                <li @click="goQuery('instrumentDetails')">
                    <p>
        ...
        <el-carousel height="450px" ref="carousel" class="carousel" :initial-index="initIndex" arrow="always"
            :interval="5000" @change="currIndex">
            <div @touchstart="start($event)" @touchmove="move($event)">

                <el-carousel-item v-for="(item, index) in carouselArr" :key="item">
                    <h2>
                    ...
                    <video loop
                        style="width: 100%;height: 100%;position: absolute;top:0;left:0;object-fit: none;z-index: -1"
                        width="100%" ref="videoPlayer" :controls="isIn">
