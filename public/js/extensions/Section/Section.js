...
Autodesk.Extensions.Section =
    ...
    ({
        ...
        /***/
            ...
            __webpack_require__.d(__webpack_exports__, "SectionExtension", function() { return SectionExtension; });
            /* harmony import */
            var _SectionTool__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__( /*! ./SectionTool */ "./extensions/Section/SectionTool.js");
            /* harmony import */
            var _Section_css__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__( /*! ./Section.css */ "./extensions/Section/Section.css");
            /* harmony import */
            var _Section_css__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/ __webpack_require__.n(_Section_css__WEBPACK_IMPORTED_MODULE_1__);
        ...
        /***/
            ...
            __webpack_require__.r(__webpack_exports__);
            /* harmony export (binding) */
            __webpack_require__.d(__webpack_exports__, "SectionTool", function() { return SectionTool; });
            /* harmony import */
            var _thirdparty_three_js_TransformControls__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__( /*! ../../thirdparty/three.js/TransformControls */ "./thirdparty/three.js/TransformControls.js");
            ...
            var SectionTool = function SectionTool(viewer, options) {
                ...
                var _tintColor = { r: 255, g: 255, b: 255 }; //自定义贴图颜色
                var _tintIntensity = options.tintIntensity; //透明度设置
                    ...
                    _fragIterator.start(models, 50, function(fragId, dbId, model, lastFrag) {
                        ...
                        if (lastFrag) {
                            if (intersects.length) {
                                ...
                                //   var c = 0xff000000 | b << 16 | g << 8 | r; //边框线条颜色0xFFAAAAAA
                                var c = b << 16 | g << 8 | r; //删除色值即可去掉边框
                                ...
                                if (cset) {
                                    ...
                                    //Create triangulated capping polygon
                                    {
                                        if (!cset.triangulationFailed) {
                                            ...
                                            // mat.hatchParams = new THREE.Vector2(tan, 10.0);//贴图上的线条
                                            mat.hatchParams = null;
                                            mat.hatchTintColor = _tintColor; //颜色设置
                                            mat.hatchTintIntensity = _tintIntensity; //透明度设置
                ...
                window.createMyOwnPlane = function(_viewer, _sectionPlanes,routerName) {
                    // console.log('去除剖切面',_sectionPlanes)
                    _removeSections();
                    _viewer.setCutPlanes();
                    if (_sectionPlanes.length === 2 && routerName) {
                 ...
                 */
                this.setViewerSection = function() {
                    var fireEvent = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : true;
	 ...
	 */
        ...
        /***/
            ...
            __webpack_require__.r(__webpack_exports__);
            /* harmony export (binding) */
            __webpack_require__.d(__webpack_exports__, "init_TransformGizmos", function() { return init_TransformGizmos; });
            /**
            ...
            function init_TransformGizmos() {
                ...
                THREE.TransformGizmoTranslate = function() {
                    ...
                    this.setHandlePickerGizmos = function() {
                        ...
                        this.handleGizmos = {
                            X: [
                                [new THREE.Mesh(arrowGeometry, new GizmoMaterial({ color: 0xf12c2c })), [0.5, 0, 0],
                                    [0, 0, -Math.PI / 2]
                                ],
                            ...
                            Z: [
                                [new THREE.Mesh(arrowGeometry, new GizmoMaterial({ color: 0x2c2cf1 })), [0, 0, 0.5],
                                    [Math.PI / 2, 0, 0]
                                ],
                        ...
                        this.pickerGizmos = {
                            X: [
                                [new THREE.Mesh(new THREE.CylinderGeometry(0.2, 0, 1, 4, 1, false), new GizmoMaterial({ color: 0xff0000, opacity: 0.25 })), [0.6, 0, 0],
                                    [0, 0, -Math.PI / 2]
                                ]
                            ],
                            ...
                            Z: [
                                [new THREE.Mesh(new THREE.CylinderGeometry(0.2, 0, 1, 4, 1, false), new GizmoMaterial({ color: 0x0000ff, opacity: 0.25 })), [0, 0, 0.6],
                                    [Math.PI / 2, 0, 0]
                                ]
                            ],
                            ...
                            YZ: [
                                [new THREE.Mesh(new THREE.PlaneBufferGeometry(0.4, 0.4), new GizmoMaterial({ color: 0x00ffff, opacity: 0.25 })), [0, 0.2, 0.2],
                                    [0, Math.PI / 2, 0]
                                ]
                            ],

                            XZ: [
                                [new THREE.Mesh(new THREE.PlaneBufferGeometry(0.4, 0.4), new GizmoMaterial({ color: 0xff00ff, opacity: 0.25 })), [0.2, 0, 0.2],
                                    [-Math.PI / 2, 0, 0]
                                ]
                            ]
                        };
                ...
                THREE.TransformGizmoRotate = function() {
                    ...
                    this.setHandlePickerGizmos = function() {
                        ...
                        this.pickerGizmos = {
                            RX: [
                                [new THREE.Mesh(new THREE.TorusGeometry(1, 0.12, 4, 12, Math.PI), new GizmoMaterial({ color: 0xff0000, opacity: 0.25 })), [0, 0, 0],
                                    [0, -Math.PI / 2, -Math.PI / 2]
                                ]
                            ],

                            RY: [
                                [new THREE.Mesh(new THREE.TorusGeometry(1, 0.12, 4, 12, Math.PI), new GizmoMaterial({ color: 0x00ff00, opacity: 0.25 })), [0, 0, 0],
                                    [Math.PI / 2, 0, 0]
                                ]
                            ],

                            RZ: [
                                [new THREE.Mesh(new THREE.TorusGeometry(1, 0.12, 4, 12, Math.PI), new GizmoMaterial({ color: 0x0000ff, opacity: 0.25 })), [0, 0, 0],
                                    [0, 0, -Math.PI / 2]
                                ]
                            ],
                ...
                THREE.TransformGizmoTranslateRotate = function() {
                    ...
                    this.setHandlePickerGizmos = function() {
                        ...
                        this.handleGizmos = {
                            Z: [
                                [new THREE.Mesh(arrowGeometry, new GizmoMaterial({ color: 0xffffff })), [0, 0, 0.25],
                                    [Math.PI / 2, 0, 0]
                                ],
                                [new THREE.Mesh(new THREE.CylinderGeometry(0.015, 0.015, 0.6, 4, 1, false), new GizmoMaterial({ color: 0xffffff })), [0, 0, 0.5],
                                    [Math.PI / 2, 0, 0]
                                ]
                            ],

                            RX: [
                                [new THREE.Mesh(new THREE.TorusGeometry(1, 0.015, 12, 60, theta * 2 * Math.PI), new GizmoMaterial({ color: 0xff0000 })), [0, 0, 0],
                                    [theta * Math.PI, -Math.PI / 2, 0]
                                ],
                                [new THREE.Mesh(new THREE.CylinderGeometry(0.05, 0.05, 0.015, 60, 1, false), new GizmoMaterial({ color: 0xff0000 })), [0, 0, 1],
                                    [Math.PI / 2, 0, 0]
                                ]
                            ],

                            RY: [
                                [new THREE.Mesh(new THREE.TorusGeometry(1, 0.015, 12, 60, theta * 2 * Math.PI), new GizmoMaterial({ color: 0x0000ff })), [0, 0, 0],
                        ...
                        this.pickerGizmos = {
                            Z: [
                                [new THREE.Mesh(new THREE.CylinderGeometry(0.12, 0.12, 0.65, 4, 1, false), new GizmoMaterial({ color: 0x0000ff, opacity: 0.25 })), [0, 0, 0.5],
                                    [Math.PI / 2, 0, 0]
                                ]
                            ],

                            RX: [
                                [new THREE.Mesh(new THREE.TorusGeometry(1, 0.12, 4, 12, theta * 2 * Math.PI), new GizmoMaterial({ color: 0xff0000, opacity: 0.25 })), [0, 0, 0],
                                    [theta * Math.PI, -Math.PI / 2, 0]
                                ]
                            ],

                            RY: [
                                [new THREE.Mesh(new THREE.TorusGeometry(1, 0.12, 4, 12, theta * 2 * Math.PI), new GizmoMaterial({ color: 0x0000ff, opacity: 0.25 })), [0, 0, 0],
                                    [Math.PI / 2, 0, (0.5 - theta) * Math.PI]
                                ]
                            ]
                        };
                        ...
                        this.highlightGizmos = {
                            ...
                            RX: [
                                [new THREE.Mesh(new THREE.TorusGeometry(1, 0.02, 12, 60, 2 * Math.PI), new GizmoMaterial({ color: 0xff0000, opacity: 1 })), [0, 0, 0],
                                    [0, -Math.PI / 2, -Math.PI / 2], false
                                ]
                            ],

                            RY: [
                                [new THREE.Mesh(new THREE.TorusGeometry(1, 0.02, 12, 60, 2 * Math.PI), new GizmoMaterial({ color: 0x0000ff, opacity: 1 })), [0, 0, 0],
                                    [Math.PI / 2, 0, 0], false
                                ]
                            ]
                        };
